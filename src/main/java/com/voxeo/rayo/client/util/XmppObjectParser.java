...
import com.voxeo.rayo.client.UnknownXmppObjectException;
...
public class XmppObjectParser {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // Otherwise, it must be a packet extension.
                	...
                	parseUnknownStanza(parser, presence);
                }
            }
            else if (eventType == XmlPullParser.END_TAG) {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // this element name and namespace.
                	...
                	parseUnknownStanza(parser, iqPacket);
                }
            }
            else if (eventType == XmlPullParser.END_TAG) {
	...
	private static void parseUnknownStanza(XmlPullParser parser, Stanza stanza)
			throws XmlPullParserException, IOException {
